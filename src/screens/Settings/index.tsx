...
import { ArrowUpCircle, Bell, BookOpen, CheckCircle, Database, Droplet, Flag, PieChart, Shield, Smartphone } from 'react-native-feather';
  ...
  return (
    <View style={{
      ...
      >
        ...
        >
          <Text style={{ fontSize: 14, marginTop: 5, color: colors.textSecondary }}>Aurora v{pkg.version}</Text>
