...
import {
  ...
  NotFoundScreen,
  PrivacyScreen,
  ReminderScreen, SettingsScreen, StatisticsHighlights, TagCreate, TagEdit, SettingsTags, SettingsTagsArchive, HomeScreen, UserProfileScreen, PremiumScreen, SignupScreen, LoginScreen, OTPVerificationScreen, ForgotPasswordScreen
} from '../screens';
...
function RootNavigator() {
  ...
  useEffect(() => {
    ...
    // After onboarding, Premium screen should be shown before tabs
    // This is handled by the conditional initialRouteName below
  ...
  return (
    ...
    >
      <Stack.Navigator
        initialRouteName={!hasActionDone('onboarding') ? "tabs" : (hasActionDone('premium_purchase') ? "tabs" : "Premium")}
        screenOptions={{
          navigationBarColor: colors.tabsBackground,
        }}
      >
        {/* Auth Flow - Add these screens before tabs */}
        <Stack.Screen
          name="Premium"
